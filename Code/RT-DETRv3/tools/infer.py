...
def run(FLAGS, cfg):
    ...
    logger.info("Start inference on {} images.".format(num_images))
    ...
    logger.info("=====================================")
    logger.info("Total inference time: {:.4f} s".format(total_time))
    logger.info("Average time per image: {:.6f} s".format(avg_time))
    logger.info("FPS (images/sec): {:.2f}".format(fps))
    logger.info("=====================================")
