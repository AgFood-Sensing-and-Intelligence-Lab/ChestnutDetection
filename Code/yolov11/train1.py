...
def parse_args():
    parser = argparse.ArgumentParser(description="Train YOLOv11 with custom hyperparameters")
    parser.add_argument("--data",    type=str, default="data.yaml", help="path to data.yaml")
    parser.add_argument("--model",   type=str, default="yolov11n.yaml",    help="model config (n/s/m/l/x)")
